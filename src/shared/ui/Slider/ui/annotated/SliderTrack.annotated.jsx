...
const SliderTrack = ({ slides, slideLabels = [], className, slideClassName }) => {
  ...
  //
  // ══ Ref ══════════════════════════════════
  // ref це посилання на коробку, змінюється значення в коробці,
  // але посилання завжди статичне (якщо не перестворювати об'єкт),
  ...
  const handleTransitionEnd = (e) => {
    ...
    // еквівалент. Та сама проблема — те само рішення.
